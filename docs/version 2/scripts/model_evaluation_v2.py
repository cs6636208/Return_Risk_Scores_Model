...
def load_resources():
    print("[INFO] Loading V2 model and data...")
...
def optimize_threshold(model, X_test, y_test):
    print("\n[INFO] Running Threshold Optimization (V2)...")
    ...
    os.makedirs('reports/model_evaluation_v2', exist_ok=True)
    cost_plot_path = 'reports/model_evaluation_v2/cost_optimization_v2.png'
...
def run_shap_analysis(model, X_test, feature_names, y_proba):
    print("\n[INFO] Running SHAP Explainability Analysis (V2)...")
    ...
    summary_path = 'reports/model_evaluation_v2/shap_summary_v2.png'
    plt.tight_layout()
    ...
    try:
        ...
        local_path = 'reports/model_evaluation_v2/shap_waterfall_top_risk_v2.png'
        plt.tight_layout()
        ...
        plt.title('Top SHAP Values (Magnitude) for Top Risk Order (V2)')
        local_path = 'reports/model_evaluation_v2/shap_bar_top_risk_v2.png'
        plt.tight_layout()
        plt.savefig(local_path, dpi=150, bbox_inches='tight')
        plt.close()
...
if __name__ == '__main__':
    print("=" * 60)
    print("MODEL EVALUATION & EXPLAINABILITY V2 (WEEK 6)")
    print("=" * 60)
    ...
    print("\n[SUCCESS] V2 Evaluation complete!")
