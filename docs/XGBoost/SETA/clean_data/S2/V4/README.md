# S2 V4 - XGBoost 80/20 Train-Test Split
...
- Featured dataset: `docs\XGBoost\SETA\clean_data\S2\V4\features\df_featured_s2_v4.csv`
- Train/test artifact: `docs\XGBoost\SETA\clean_data\S2\V4\features\train_test_sets_s2_v4.pkl`
- Model: `docs\XGBoost\SETA\clean_data\S2\V4\models\model_s2_v4_xgboost.pkl`
- Metrics: `docs\XGBoost\SETA\clean_data\S2\V4\reports\metrics_s2_v4.csv`
- Test predictions: `docs\XGBoost\SETA\clean_data\S2\V4\reports\test_predictions_s2_v4.csv`
